...
hi CursorIM ctermfg=NONE ctermbg=168 cterm=NONE guifg=NONE guibg=#FF4ACC gui=NONE
...
hi DiffText ctermfg=234 ctermbg=168 cterm=bold guifg=#1C1C1C guibg=#FF4ACC gui=bold
hi EndOfBuffer ctermfg=119 ctermbg=NONE cterm=NONE guifg=#000000 guibg=NONE gui=NONE
hi ErrorMsg ctermfg=168 ctermbg=NONE cterm=bold guifg=#FF4ACC guibg=NONE gui=bold
...
hi LineNr ctermfg=240 ctermbg=233 cterm=NONE guifg=#585858 guibg=#000000 gui=NONE
...
hi Normal ctermfg=252 ctermbg=NONE cterm=NONE guifg=#FFFFFF guibg=#000000 gui=NONE
...
hi Search ctermfg=16 ctermbg=147 cterm=bold guifg=#000000 guibg=#AF5FFF gui=bold
hi SpecialKey ctermfg=97 ctermbg=NONE cterm=NONE guifg=#875FAF guibg=NONE gui=NONE
hi SpellBad ctermfg=168 ctermbg=NONE cterm=underline guifg=#FF4ACC guibg=NONE gui=underline,italic
hi SpellCap ctermfg=168 ctermbg=NONE cterm=underline guifg=#FF4ACC guibg=NONE gui=underline,italic
hi SpellLocal ctermfg=168 ctermbg=NONE cterm=underline guifg=#FF4ACC guibg=NONE gui=underline,italic
hi SpellRare ctermfg=168 ctermbg=NONE cterm=underline guifg=#FF4ACC guibg=NONE gui=underline,italic
...
hi WarningMsg ctermfg=168 ctermbg=NONE cterm=bold guifg=#FF4ACC guibg=NONE gui=bold
...
hi String ctermfg=151 ctermbg=NONE cterm=NONE guifg=#FFF7D0 guibg=NONE gui=NONE
hi Number ctermfg=179 ctermbg=NONE cterm=NONE guifg=#D7AF5F guibg=NONE gui=NONE
hi PreProc ctermfg=135 ctermbg=NONE cterm=NONE guifg=#FF4ACC guibg=NONE gui=NONE
hi Identifier ctermfg=147 ctermbg=NONE cterm=NONE guifg=#CAA9FF guibg=NONE gui=NONE
hi Statement ctermfg=171 ctermbg=NONE cterm=NONE guifg=#FF4ACC guibg=NONE gui=NONE
hi Type ctermfg=156 ctermbg=NONE cterm=NONE guifg=#AFFF87 guibg=NONE gui=NONE
hi Special ctermfg=179 ctermbg=NONE cterm=NONE guifg=#DB50BF guibg=NONE gui=NONE
hi Underlined ctermfg=119 ctermbg=NONE cterm=underline guifg=#87FF5F guibg=NONE gui=underline
hi Error ctermfg=168 ctermbg=NONE cterm=underline guifg=#FF4ACC guibg=NONE gui=underline
hi Todo ctermfg=168 ctermbg=NONE cterm=bold guifg=#FF4ACC guibg=NONE gui=bold
"hi Ignore
...
hi javaScriptFuncDef ctermfg=168 ctermbg=NONE cterm=NONE guifg=#FF4ACC guibg=NONE gui=NONE
"}}}
" Ruby"{{{
hi! rubyRegexp ctermfg=168 ctermbg=NONE cterm=bold guifg=#FF4ACC guibg=NONE gui=bold
hi! rubyRegexpDelimiter ctermfg=168 ctermbg=NONE cterm=bold guifg=#FF4ACC guibg=NONE gui=bold
...
hi GitGutterDelete ctermfg=168 ctermbg=NONE cterm=bold guifg=#FF4ACC guibg=NONE gui=bold
"}}}
"
